...
const SpriteShader = preload("res://mods/zSkele_Bootlegs/shadersoverride/sprite_ext.shader")
const SpriteShaderUnshaded = preload("res://mods/zSkele_Bootlegs/shadersoverride/sprite_unshaded_ext.shader")
const RenderThroughShader = preload("res://mods/zSkele_Bootlegs/shadersoverride/render_through_ext.shader")
const RenderThroughShaderUnshaded = preload("res://mods/zSkele_Bootlegs/shadersoverride/render_through_unshaded_ext.shader")
const ScissorShader = preload("res://mods/zSkele_Bootlegs/shadersoverride/alpha_scissor_ext.shader")
const ScissorShaderUnshaded = preload("res://mods/zSkele_Bootlegs/shadersoverride/alpha_scissor_unshaded_ext.shader")
